...
image_of_Bishoy_Bassem = face_recognition.load_image_file(r"D:\image_folder")
Bishoy_Bassem_face_encoding = face_recognition.face_encodings(image_of_Bishoy_Bassem)[0]

# Populate the known face encodings and their names
known_face_encodings = [Bishoy_Bassem_face_encoding]
known_face_names = ["Bishoy_Bassem"]
...
def trigger_capture():
    ...
    esp_cam_url = "http://192.168.114.43/capture"
...
def play_sound_on_esp(file_number):
    ...
    esp_play_sound_url = "http://<192.168.15.11" + str(file_number)
    try:
